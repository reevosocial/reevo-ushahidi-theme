<style>
svg[id^="OpenLayers_Layer_Vector_RootContainer_"][id$="_svgRoot"] {
	margin-top: 0px;
}
</style>

<div id="content">
<div class="content-bg" style="top:120px;">

<div id="main" class="report_detail">

	<div class="left-col">
<div style="width:525px;" class="box-1-top"></div>
  	  <?php
		...
		<div class="report-description-text">
			...
			<span class="description-intro"><?php echo html::clean(nl2br($incident_description)); ?></div>
		...
		<div class="<?php if( count($incident_photos) > 0 || count($incident_videos) > 0){ echo "report-media";}?>">
			...
			{
				echo '<h2>'. Kohana::lang("ui_main.reports_media").'</h2>';
			...
			<div class="credibility">
			<h2><?php echo Kohana::lang('ui_main.reports_news_2');?></h2>
				<ul>
					<?php
						foreach( $incident_news as $incident_new)
						{
							?>
							<li><a href="<?php echo $incident_new; ?> " target="_blank"><?php
							echo $incident_new;?></a></li>
