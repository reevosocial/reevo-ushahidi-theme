<script>
		$(document).ready(function() {
				...
				$('#category-column-1>li>ul>li').tooltipster({
					position: 'right',
					delay: 50,
					offsetX: 0,
  				offsetY: 0,
				...
				$('#custom_field_23_inner .report_row').tooltipster({
					position: 'right',
					delay: 50,
					offsetX: 0,
  				offsetY: -15,
				...
				// Sitio web y otros input fields
				$('.report_row_text').tooltipster({
					position: 'right',
					delay: 50,
					offsetX: -20,
  				offsetY: -20,
				...
				// Checkbox 
				$('.custom-field-option[title]').tooltipster({
					position: 'right',
					delay: 50,
					offsetX: 0,
  				offsetY: 0,
		...
		<div class="big-block">
			...
			<div class="report_left">
				<div class="report_row">
					...
					<?php endif; ?>
					<h4><?php echo Kohana::lang('ui_main.reports_title_2'); ?> <span class="required">*</span> </h4>
				...
				<div class="report_row">
					<h4><?php echo Kohana::lang('ui_main.reports_categories_2'); ?> <span class="required">*</span></h4>
			...
			<div class="report_right">
				...
				<?php endif; ?>
				<div class="report_row">
					<h3 style="margin: 0;"><?php echo Kohana::lang('ui_main.reports_location_title'); ?></h3>
				...
				<div id="divPhoto" class="report_row">
					...
					<h3 ><?php echo Kohana::lang('ui_main.reports_optional_2'); ?></h3>
					<div class="report_row">
				...
				<div class="report_row">
					<input name="submit" type="submit" value="<?php echo Kohana::lang('ui_main.reports_btn_submit_2'); ?>" class="btn_submit" /> 
				</div>
			</div>
		</div>
